import { View, Text, Image, Button, ScrollView, Dimensions, TouchableOpacity, StyleSheet, Pressable } from 'react-native'
...
const DetailScreen = ({ route }) => {
  ...
  const renderItem = ({ item }) => {
    ...
    return (
      <View style={style.styleCarouselView}>
        <Image
          style={style.styleCarouselImage}
          source={{ uri: item }} />
      </View>
    )
  }
  ...
  return (<>
    ...
    <View style={style.styleBackgroundWithoutMap}>
      ...
      <ScrollView style={{ height: windowHeight * 0.22, paddingHorizontal: 10 }}>
      ...
      <View style={style.styleViewShareIcon}>
        ...
        <Pressable
          ...
          onPress={() => seticon(icon == 'bookmark' ? 'bookmark-outline' : 'bookmark')} >
